...
import { Lock, Mail, Eye, EyeOff, ChevronRight, Shield, Zap, User } from 'lucide-react';
      ...
      <main className="flex-1 flex items-center justify-center px-8 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-1">{comman.CreateAccount}</h2>
            <p className="text-gray-700 text-sm">{comman.JoinSafeNet}</p>
          </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder={comman.NamePlaceholder}
                  />
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                  ...
                  <Link to="/terms" className="text-blue-600 hover:text-blue-700 font-medium">
                    {comman.TermsOfService}
                  </Link>{' '}
                  {comman.And}{' '}
                  <Link to="/privacy" className="text-blue-600 hover:text-blue-700 font-medium">
                    {comman.PrivacyPolicy}
                  </Link>
                </label>
              </div>
              ...
              >
                {isLoading ? (
                  <>
                    ...
                    {comman.CreatingAccount}
                  </>
                ) : (
                  <>
                    {comman.CreateAccount}
          ...
          <div className="mt-4 text-center">
            <p className="text-gray-600 text-sm">
              {comman.AlreadyHaveAccount}{' '}
              <Link to="/login" className="font-medium text-gray-800 hover:text-blue-600 transition-colors">
                {comman.SignIn}
              </Link>
            </p>
          </div>
      ...
      <footer className="relative z-10 py-3 px-8">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-500 text-xs">
            © {new Date().getFullYear()} Safe Net. All rights reserved.
          </p>
        </div>
      </footer>
